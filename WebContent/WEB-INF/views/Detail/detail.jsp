		...
		<div class="rightTbl">
			<div class="innerRightBox">
				...
				<div class="tableProfile">
					<div class="proflBox">
						<img class="profImg" src="${profile.profile_image }"
				...
				<div>
					<div class="likeModal">
						<h5>
							<a id="heartCount" href="#ex3" class="text post" rel="modal:open"></a>
						</h5>
					</div>
					<div id="modalList likeList">
						<div id='ex3' class='modal likeList' style="overflow:scroll; overflow-x:hidden">
						...
						<c:forEach items="${likeList }" var="i">
							<tr>
								...
								<td>
									<span class='modal-like' onclick='profile(${i.user_seq })'>${i.user_nickname }</span>
								</td>
								<td>
									<div class="list-btn">
									<c:if test='${follow eq true }'>
										<button type='button' id='followBtn' onclick='follow(${i.user_seq })' class='text btn btn-primary followBtn' value='Unfollow'>
										Following</button>
									</c:if>
									<c:if test='${follow eq false  }'>
										<button type='button' id='followBtn' onclick='follow(${i.user_seq })' class='text btn btn-outline-primary unfollowBtn' value='Follow'>
										Follow</button>
									</c:if>
								</div>
								</td>
